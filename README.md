...
## 📁 Repository structure
    ...
    ├── 📁 clusters
    │   ├── 📁 apps                      # Flux configurations for the Kubernetes application layer (depends on infra)
    │   ├── apps-group.yaml
    │   ├── 📁 flux-system               # Flux controllers and system components
    │   ├── 📁 infra                     # Flux configurations for the infrastructure layer (deployed first)
    │   └── infra-group.yaml
...
For CI, I use [auto-pr](https://github.com/Belorq/flux-lab/blob/main/.github/workflows/auto-pr.yaml) to automatically create pull requests from branches generated by Flux. \
